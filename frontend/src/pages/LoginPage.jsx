...
const AnimatedAutomationBackground = () => {
  return (
    <div className="absolute inset-0 overflow-hidden pointer-events-none">
      ...
      <div className="automation-icon" style={{ left: "8%",  top: "14%", animationDelay: "0s"   }}>⚙️</div>
      <div className="automation-icon" style={{ left: "78%", top: "18%", animationDelay: "0.3s", fontSize: "1.4rem" }}>→</div>
      <div className="automation-icon" style={{ left: "12%", top: "70%", animationDelay: "0.6s" }}>⚡</div>
      <div className="automation-icon" style={{ left: "82%", top: "72%", animationDelay: "0.9s", fontSize: "1.4rem" }}>✓</div>
      <div className="automation-icon" style={{ left: "70%", top: "45%", animationDelay: "0.15s" }}>🔄</div>
      <div className="automation-icon" style={{ left: "6%",  top: "42%", animationDelay: "0.45s", fontSize: "1.2rem" }}>▶</div>
    </div>
  );
};
...
const LoginPage = () => {
  ...
  return (
    <div className="h-screen overflow-hidden flex items-center justify-center bg-white font-sans relative">
      ...
      {/* Centered form card */}
      <div className="relative z-10 w-full max-w-sm bg-white border border-gray-200 rounded-2xl shadow-sm px-8 py-8 mx-4">

        {/* Heading */}
        <div className="mb-5">
          <h2 className="text-2xl font-bold text-black mb-1">Sign in</h2>
          <p className="text-sm text-gray-500">Continue to your automations</p>
        </div>
          ...
          <div>
            ...
            <div className="relative">
              <input
                ...
                required
                placeholder="••••••••"
                className="w-full bg-gray-50 border-2 border-gray-200 rounded-xl px-4 py-2.5 text-sm text-black placeholder-gray-400 outline-none focus:border-black focus:bg-white transition-all pr-14"
              />
              <button
                type="button"
            ...
            <label className="flex items-center gap-2 cursor-pointer" onClick={() => setRemember(!remember)}>
              <div
                className={`w-4 h-4 rounded border-2 flex items-center justify-center transition-all ${
                  remember ? "bg-black border-black" : "bg-white border-gray-300"
                }`}
              >
                {remember && (
              ...
              <span className="text-xs text-gray-600 select-none font-medium">Remember me</span>
            </label>
            <Link
              to="/forgot-password"
        ...
        <p className="text-center text-xs text-gray-600 mt-4">
          New here?{" "}
          <Link to="/register" className="font-semibold text-black hover:text-gray-700 transition-colors">
            Create account
          </Link>
        </p>
      </div>
